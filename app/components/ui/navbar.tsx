        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="  md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link
                  href="https://play.google.com/store/apps/details?id=com.priceTracker.shopwise&pcampaignid=web_share"
                  className="btn-sm text-white bg-blue-500 ml-3 hover:text-blue-500 hover:bg-blue-200 "
                >
                  Download Now
                </Link>
              </li>
